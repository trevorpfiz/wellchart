...
import type { HealthCheckResponse, UploadZipData, UploadZipResponse } from './types.gen';
...
export class UploadService {
     ...
     * @throws ApiError
     */
    public static uploadZip(data: UploadZipData): CancelablePromise<UploadZipResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/v1/upload',
